...
/**
 * A cleared card transaction (read-only).
 *
 ...
 * @property-read list<string>|null $matched_authorizations
 ...
 * @property-read string|null $posted_date
 */
final class IssuingTransaction extends AirwallexObject
{
}
